...
% \begin{frame}[fragile]{\sc{Проверка электронной подписи -- 1.}}
...
% 
% \begin{frame}[fragile]{\sc{Проверка электронной подписи -- 2.}}
...
% gpg:          trusted signature!
% gpg:          There is no indication that the signature
% gpg:          belongs to the owner. [\RaisedLeftHand]
